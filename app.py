...
from vehicle_loan_default.constants import APP_HOST, APP_PORT
from vehicle_loan_default.pipeline.prediction_pipeline import VehicleLoanData, VehicleLoanClassifier
from vehicle_loan_default.pipeline.training_pipeline import TrainPipeline
...
async def predictRouteClient(request: Request):
    try:
        ...
        model_predictor = VehicleLoanClassifier()
