...
from vehicle_loan_default.cloud_storage.aws_storage import SimpleStorageService
from vehicle_loan_default.exception import VehicleLoanException
from vehicle_loan_default.logger import logging
from vehicle_loan_default.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from vehicle_loan_default.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = VehicleLoanEstimator(bucket_name=model_pusher_config.bucket_name,
