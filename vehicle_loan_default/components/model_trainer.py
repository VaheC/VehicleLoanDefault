...
from vehicle_loan_default.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from vehicle_loan_default.entity.config_entity import ModelTrainerConfig
from vehicle_loan_default.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            usvisa_model = VehicleLoanModel(preprocessing_object=preprocessing_obj,
